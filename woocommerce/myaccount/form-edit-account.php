...
<form class="woocommerce-EditAccountForm edit-account row justify-content-center p-2" action=""
      method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?> >

    <?php do_action('woocommerce_edit_account_form_start'); ?>

    <p class="woocommerce-form-row woocommerce-form-row--first form-row col-12 col-lg-6 form-floating px-lg-1">
        <label for="account_first_name form-label"><?php esc_html_e('First name', 'woocommerce'); ?>&nbsp;<span
                    class="required">*</span></label>
        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control text-end"
               name="account_first_name" id="account_first_name" autocomplete="given-name"
               value="<?php echo esc_attr($user->first_name); ?>"/>
    </p>
    <p class="woocommerce-form-row woocommerce-form-row--last form-row col-12 col-lg-6 form-floating px-lg-1">
    ...
    <p class="woocommerce-form-row woocommerce-form-row--first form-row col-12 col-lg-6 form-floating px-lg-1">
        <label for="account_email"><?php esc_html_e('Email address', 'woocommerce'); ?>&nbsp;<span
                    class="required">*</span></label>
        <input type="email" class="woocommerce-Input woocommerce-Input--email input-text form-control ps-5"
    ...
    <fieldset>
        <legend><?php esc_html_e('Password change', 'woocommerce'); ?></legend>
            ...
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                ...
                <input type="password"
                       class="woocommerce-Input woocommerce-Input--password input-text form-control ps-5"
    ...
    <p>
        ...
        <button type="submit" class="woocommerce-Button button btn bg-red text-white mt-2" name="save_account_details"
